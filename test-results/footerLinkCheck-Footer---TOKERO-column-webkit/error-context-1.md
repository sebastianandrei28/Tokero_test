...
Expected: "careers/"
Received: "https://tokero.team/"
    at map (D:\workspace\playwright\Tokero_test\tests\footerLinkCheck.spec.ts:82:25)
    at staticValidationOfLinks (D:\workspace\playwright\Tokero_test\tests\footerLinkCheck.spec.ts:77:16)
    at D:\workspace\playwright\Tokero_test\tests\footerLinkCheck.spec.ts:159:11
    at D:\workspace\playwright\Tokero_test\tests\footerLinkCheck.spec.ts:158:14
```
    ...
    - list:
      ...
      - listitem:
        - button "en flag EN":
          - img "en flag"
          - text: EN
- paragraph: Please wait, page is loading...
- contentinfo:
