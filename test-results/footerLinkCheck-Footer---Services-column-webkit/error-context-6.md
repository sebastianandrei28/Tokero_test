...
- Name: Footer - Services column
- Location: D:\workspace\playwright\Tokero_test\tests\footerLinkCheck.spec.ts:183:5
...
Received: false
    ...
    at D:\workspace\playwright\Tokero_test\tests\footerLinkCheck.spec.ts:206:5
    at D:\workspace\playwright\Tokero_test\tests\footerLinkCheck.spec.ts:205:3
```
    ...
    - list:
      ...
      - listitem:
        - button "en flag EN":
          ...
          - text: EN
- paragraph
- heading "Apply for Listing on TOKERO" [level=1]
- paragraph: Log in or register to continue.
- link "Login":
  - /url: /en/login/
- link "Register":
  - /url: /en/register/
